...
- Na pasta principal, **crie um arquivo HTML** (ex: `principal.html`)
...
![Página exibindo o primeiro passo](passo-a-passo/passo1.png) <!-- {.bordered.rounded.push-right style="height: 120px;"} -->
...
- ![Página exibindo o primeiro passo](passo-a-passo/passo2.png) <!-- {.bordered.rounded.push-right style="height: 240px;"} -->
...
- Título (segundo nível): "Funcionamento do Coding Dojo"
  ...
  ![Página exibindo o terceiro passo](passo-a-passo/passo3.png) <!-- {.bordered.rounded.push-right style="height: 280px;"} -->
...
- **Apenas o primeiro parágrafo** deve ser:
  ![Página exibindo o quarto passo](passo-a-passo/passo4.png) <!-- {.bordered.rounded.push-right.bullet style="height: 250px;"} -->
  - Cor de fundo: Azure
...
![Página exibindo o quinto passo](passo-a-passo/passo5.png) <!-- {.bordered.rounded.push-right style="height: 300px;"} -->
...
- ![Página exibindo o sexto passo](passo-a-passo/passo6.png) <!-- {.bordered.rounded.push-right style="height: 420px;"} -->
...
![Página exibindo o sétimo passo](passo-a-passo/passo7.png) <!-- {.bordered.rounded.bullet.push-right style="width: 300px;"} -->
...
- Crie uma pasta chamada `outras-paginas` e, dentro dela, um arquivo HTML
  chamado `links.html`
![Página exibindo o oitavo passo](passo-a-passo/passo8.png) <!-- {.bordered.rounded.push-right style="height: 125px;"} -->
...
![Página exibindo o primeiro passo](passo-a-passo/passo9.png) <!-- {.bordered.rounded.push-right style="width: 400px;"} -->
...
- Na página inicial, crie um link para a página de links
  ![Página exibindo o primeiro passo](passo-a-passo/passo10.png) <!-- {.bordered.rounded.push-right style="height: 380px;"} -->
